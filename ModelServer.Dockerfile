...
COPY 'edupra-model-evaluator' '/usr/local/lib/python3.6/site-packages/edupra-model-evaluator'
...
RUN pip install --upgrade pip && \
    ...
    pip install -e '/usr/local/lib/python3.6/site-packages/edupra-model-evaluator' && \
